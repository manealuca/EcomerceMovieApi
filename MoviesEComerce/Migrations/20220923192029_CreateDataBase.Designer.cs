...
namespace MoviesEComerce.Migrations
{
    ...
    [Migration("20220923192029_CreateDataBase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoviesEComerce.Models.Applicationuser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MoviesEComerce.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviesEComerce.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviesEComerce.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MoviesEComerce.Models.Applicationuser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MoviesEComerce.Models.Order", b =>
                {
                    b.HasOne("MoviesEComerce.Models.Applicationuser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MoviesEComerce.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("MoviesEComerce.Models.Order", "Order")
                        .WithMany("OrderItems")
